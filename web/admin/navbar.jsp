        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../adminLogout"><i class="fa-solid fa-right-from-bracket"></i>LOGOUT</a>
                    </li>
            ...
            <!--<div class="dropdown">
                    <button class="btn btn-light dropdown-toggle" type="button"
                            ...
                            <a class="dropdown-item" href="../adminLogout">Logout</a></li>
                    </ul>
            </div>-->
            <!--</form>-->
        </div>
